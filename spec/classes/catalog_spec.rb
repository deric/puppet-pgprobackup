...
describe 'pgprobackup::catalog' do
  ...
  context 'when running with default parameters' do
    ...
    it {
      is_expected.to contain_file('/var/lib/pgbackup').with(ensure: 'directory',
                                                            owner: 'pgbackup',
                                                            group: 'pgbackup',
                                                            mode: '0750')
    }
    ...
    it {
      is_expected.to contain_file('/var/lib/pgbackup/backups').with(ensure: 'directory',
                                                                    owner: 'pgbackup',
                                                                    group: 'pgbackup',
                                                                    mode: '0750')
    }
    ...
    it {
      is_expected.to contain_file('/var/lib/pgbackup/wal').with(ensure: 'directory',
                                                                owner: 'pgbackup',
                                                                group: 'pgbackup',
                                                                mode: '0750')
    }
